...
public final class MeshGeometry {
    ...
    public static MeshGeometry concat(List<MeshGeometry> parts, PartOffsets offsets) {
        if (parts.size() == 1) {
            if (offsets != null) {
                offsets.moved(parts.get(0), 0);
            }
            return parts.get(0);
        }
    ...
    @FunctionalInterface
    public interface PartOffsets {
        void moved(MeshGeometry part, int vertexBase);
    }
}
