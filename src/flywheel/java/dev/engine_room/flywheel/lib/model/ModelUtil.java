...
public final class ModelUtil {
	...
	// The vanilla RenderType -> Material mapping that used to live here went with the baked-model
	// interop: it only ever served chunk and item rendering, which this fork does not carry. See
	// src/flywheel/NOTICE.md.
