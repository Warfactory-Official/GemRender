...
public final class HitboxComponent implements EntityComponent {
	// 26.1 dropped FULL_BLOCK; LightCoordsUtil kept the same packing.
	...
	public void beginFrame(DynamicVisual.Context context) {
		...
		// 26.1 moved the hitbox toggle off EntityRenderDispatcher and onto the debug-screen entry list,
		// which is what F3+B now flips (see KeyboardHandler).
