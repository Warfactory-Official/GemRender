...
public abstract class AbstractEntityVisual<T extends Entity> extends AbstractVisual implements EntityVisual<T> {
	...
	public boolean isVisible(FrustumIntersection frustum) {
		// Entity#noCulling became EntityRenderer#affectedByCulling, inverted.
		return !EntityVisibilityTester.affectedByCulling(entity) || visibilityTester.check(frustum);
	}
